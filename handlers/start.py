...
async def cmd_start(message: Message, state: FSMContext) -> None:
    ...
    text = (
        "Привет! Я Бот, который создаст для тебя музыкальный подарок и подарит яркие эмоции "
        "твоим родным и близким. Всего за несколько минут, я сделаю для тебя уникальную песню, "
